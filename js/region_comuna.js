...
// Declaro el evento para que se ejecute la funcion poblarComunas() al cambiar la region
document.getElementById("region").addEventListener("change", poblarComunas);

// Llamo a la funcion poblarRegiones() para que se ejecute al cargar la pagina
document.addEventListener("DOMContentLoaded", poblarRegiones);
// Llamo a la funcion poblarComunas() para que se ejecute al cargar la pagina
document.addEventListener("DOMContentLoaded", poblarComunas);